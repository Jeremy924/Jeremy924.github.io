...
def handle_updatable(args):
    ...
    for app in parsed_apps:
        ...
        if latest_compatible_version == None:
            print("\033[1;31mNo versions of the app are compatible with this firmware version.\033[0m")
            ser.write("echo on\n".encode())
            return
...
header_location = 'https://jeremy924.github.io/rp42/downloads/header0.3.3.txt'
...
def main():
    ...
    parser_reset = subparsers.add_parser('reset', help='Resets RP-42')
